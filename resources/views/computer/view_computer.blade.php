    ...
    <div class="container mt-5 p-5">
        <div class="card p-5 shadow-lg">
            <div class="text-center mt-2">
                <h2 class="fw-bold"><i class="fa fa-eye me-2" aria-hidden="true"></i>View Computer</h2>
                <img src="{{ asset('Computer_Image/'.$view_computer->image) }}" 
                    class="rounded-circle mt-2 img-fluid"
                    style="width: 280px; height: 280px;" alt="Computer Image">
                <h2>{{ $view_computer->computer_name }}</h2>
                <p><strong>Price:</strong>{{ $view_computer->price }}</p>
                <p><strong>Description:</strong>{{ $view_computer->description }}</p>
                <p><strong>Student ID:</strong>{{ $view_computer->student_id }}</p>
                <p><strong>Teacher ID:</strong>{{ $view_computer->teacher_id }}</p>
                <p><strong>Subject ID:</strong>{{ $view_computer->subject_id }}</p>
                <p><strong>Country ID:</strong>{{ $view_computer->country_id }}</p>
