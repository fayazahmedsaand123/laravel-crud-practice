...
@section('navbar')
    ...
    <div class="navbar">
        ...
        <div class="navbar-right">
            {{-- Search --}}
            <div class="search">
                <form action="{{ route('record_computer') }}" method="get">
...
@section('content')
    <div class="main-center">
            ...
            <tbody>
                @forelse ($computers as $computer)
                    <tr>
                        ...
                        <td>{{ $computer->student_id }}</td>
                        <td>{{ $computer->teacher_id }}</td>
                        <td>{{ $computer->subject_id }}</td>
                        <td>{{ $computer->country_id }}</td>
                        <td>
                            <img src={{ asset('Computer_Image/'.$computer->image) }} alt="Computer Image">
                        </td>
                        <td>
                            <a href="{{ route('view_computer',$computer->id) }}" class="btn-view">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('update_computer',$computer->id) }}" class="btn-update">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('delete_computer',$computer->id) }}" class="btn-delete" 
                                data-id="{{ $computer->id }}">
        ...
        {{-- Pagination --}}
        <div class="mt-3 pagination-left">{{ $computers->links('pagination::bootstrap-5') }}</div>
    </div>
@endsection
