...
@section('content')
    ...
    <div class="main-center">
        <h1>➕ Subject Form</h1>
        <form action="{{ route('subject_add') }}" id="subject_add" method="post" enctype="multipart/form-data">
            @csrf
            {{-- Name field --}}
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="religious" placeholder="Enter religious">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Phone number field --}}
