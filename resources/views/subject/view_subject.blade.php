    ...
    <div class="container mt-5 p-5">
        <div class="card p-3 shadow-lg">
            <div class="text-center mt-2">
                <h2 class="fw-bold"><i class="fa fa-eye me-2" aria-hidden="true"></i>View Subject</h2>
                <img src="{{ asset('Subject_Image/'.$view_subject->image) }}"
                    class="rounded-circle mt-2 img-fluid"
                    style="width: 280px; height: 280px;" alt="View Image">
                <h2 class="fw-bold">{{ $view_subject->name }}</h2>
                <p><strong>Age:</strong> {{ $view_subject->age }}</p>
                <p><strong>Religious:</strong> {{ $view_subject->religious }}</p>
                <p><strong>Phone:</strong> {{ $view_subject->phone }}</p>
                <p><strong>Student_ID:</strong>{{ $view_subject->student_id }}</p>
                <p><strong>Teacher_ID:</strong> {{ $view_subject->teacher_id }}</p>
