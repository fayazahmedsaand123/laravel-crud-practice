...
@section('navbar')    
    ...
    <div class="navbar">
        ...
        <div class="navbar-right">
            {{-- Search --}}
            <div class="search">
                <form action="{{ route('record_subject') }}" method="get">
...
@section('content')
    <div class="main-center">
        ...
        <table>
            ...
            <tbody>
                @forelse ($record_subject as $subject)
                    <tr>
                    {{-- <td>{{ $subject->id }}</td> --}}   
                    <td>{{ $subject->name }}</td>
                    <td>{{ $subject->age }}</td>
                    <td>{{ $subject->religious }}</td>
                    <td>{{ $subject->phone }}</td>
                    <td>{{ $subject->student_id }}</td>
                    <td>{{ $subject->teacher_id }}</td>
                    <td>
                        <img src="{{ asset('Subject_Image/'.$subject->image) }}" alt="Subject Image">
                    </td>
                    <td>
                        <a href="{{ route('view_subject',$subject->id) }}" class="btn-view">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                    </td>
                    <td>
                        <a href="{{ route('update_subject',$subject->id) }}" class="btn-update">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                    </td>
                    <td>
                        <a href="{{ route('delete_subject',$subject->id) }}" 
                            class="btn-delete" data-id="{{ $subject->id }}">
        ...
        {{-- Pagination --}}
        <div class="mt-3 pagination-left">{{ $record_subject->links('pagination::bootstrap-5') }}</div>
    </div>
@endsection
