    ...
    <div class="container mt-5 p-5">
        <div class="card p-5 shadow-lg">
            <div class="text-center mt-2">
                <h2 class="fw-bold"><i class="fa fa-eye me-2" aria-hidden="true"></i>View Teacher</h2>
                <img src="{{ asset('Teacher_Image/'.$view_teacher->image) }}"
                    class="rounded-circle mt-2 mb-2 img-fluid" 
                    style="width: 280px; height: 280px; object-fit: cover;" alt="View Image">
                <h2 class="fw-bold">{{ $view_teacher->name }}</h2>
                <p><strong>Gender:</strong> {{ $view_teacher->gender }}</p>
                <p><strong>Subject:</strong> {{ $view_teacher->subject }}</p>
                <p><strong>Department:</strong> {{ $view_teacher->department }}</p>
                <p><strong>Nationally:</strong> {{ $view_teacher->nationally }}</p>
                <p><strong>Student_ID:</strong> {{ $view_teacher->student_id }}</p>
