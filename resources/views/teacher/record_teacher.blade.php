...
@section('navbar')
    ...
    <div class="navbar">
        ...
        <div class="navbar-right">
            {{-- Search --}}
            <div class="search">
                <form action="{{ route('record_teacher') }}" method="get">
...
@section('content')
    <div class="main-center">
        ...
        <table>
            ...
            <tbody>
                @forelse ($record_teacher as $teacher)
                    <tr>
                        {{-- <td>{{ $teacher->id }}</td> --}}   
                        <td>{{ $teacher->name }}</td>
                        ...
                        <td>{{ $teacher->nationally }}</td>
                        <td>{{ $teacher->student_id }}</td>
                        <td>
                            <img src="{{ asset('Teacher_Image/'.$teacher->image) }}" alt="Teacher Image">
                        </td>
                        <td>
                            <a href="{{ route('view_teacher',$teacher->id) }}" class="btn-view">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('update_teacher',$teacher->id) }}" class="btn-update">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('delete_teacher',$teacher->id) }}"
                                class="btn-delete" data-id="{{ $teacher->id }}">
        ...
        {{-- Pagination --}}
        <div class="mt-3 pagination-left">{{ $record_teacher->links('pagination::bootstrap-5') }}</div>
    </div>
@endsection
