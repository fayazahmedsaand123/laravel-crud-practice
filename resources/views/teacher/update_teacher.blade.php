...
@section('content')
    ...
    <div class="main-center">
        <h1><i class="fa fa-pencil-square me-2" aria-hidden="true"></i>Update Teacher</h1>
        <form action="{{ route('update_teacher_post',$update_teacher->id) }}" id="update_teacherPOST" method="post" enctype="multipart/form-data">
            @csrf
            {{-- Name field --}}
            <div class="form-group">
                <label class="form-label">First Name </label>
                <div class="input-wrapper">
                    <input type="text" name="name" value="{{ $update_teacher->name }}" placeholder="Enter name">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="gender" value="{{ $update_teacher->gender }}" placeholder="Enter gender">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Subject field --}}
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="subject" value="{{ $update_teacher->subject }}" placeholder="Enter subject">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Department field --}}
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="department" value="{{ $update_teacher->department }}" placeholder="Enter department">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Nationally field --}}
            <div class="form-group">
                <label class="form-label">Nationally </label>
                <div class="input-wrapper">
                    <input type="text" name="nationally" value="{{ $update_teacher->nationally }}" placeholder="Enter nationally">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Dropdown Student --}}
            <div class="form-group">
                ...
                <select name="student_id" class="select-foregin">
                    <option class="select">Select Students</option>
                    @foreach ($students as $student)
                        <option value="{{ $student->id }}"
                            {{ $update_teacher->student_id == $student->id ? 'selected' : '' }}>
                            {{ $student->id }} </option>
                    @endforeach
                </select>
            ...
            {{-- Image picture --}}
            <div class="form-group">
                <img id="imagePreview" src="{{$update_teacher->image ? asset('/Teacher_Image/'.$update_teacher->image):
                    asset('/Teacher_Image/default.png') }}" alt="Teacher Image">
            </div>
            {{-- Image field --}}
            <div class="form-group">
...
@section('scripts')
    <script>
        $(document).ready(function() {
            $('#update_teacherPOST').on('submit',function(e) {
                e.preventDefault();
                var formData = new FormData(this);
                var update_teacher = $(this).attr('action');
