...
@section('navbar')
    ...
    <div class="navbar">
        ...
        <div class="navbar-right">
            {{-- Search --}}
            <div class="search">
                <form action="{{ route('record_quiz') }}" method="get">
...
@section('content')
    <div class="main-center">   
            ...
            <tbody>
                @forelse ($questions as $question)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('view_quiz',$question->id) }}" class="btn-view">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('update_quiz',$question->id) }}" class="btn-update">
                                <i class="fa fa-pencil-square" aria-hidden="true"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('delete_quiz',$question->id) }}" data-id="{{ $question->id }}" class="btn-delete">
        ...
        {{-- Pagination --}}
        <div class="mt-3 pagination-left">{{ $questions->links('pagination::bootstrap-5') }}</div>
    </div>
@endsection
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            // ====================== Table Question MCQ's Dropdown Arrow ====================== //
