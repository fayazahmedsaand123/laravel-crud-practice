...
@section('content')
    ...
    <div class="container mt-5 p-5">
        ...
        @endif
        <h2 class="text-center">➕ Add MCQ</h2>
        <form action="{{ route('mcq.store') }}" id="Mcq_ajax" method="post">
            @csrf
            {{-- Question field --}}
            <div class="mb-3">
            ...
            <div class="mb-3 text-center">
                <button type="submit" class="btn btn-primary"><i class="fa fa-plus me-2" aria-hidden="true"></i>Add MCQ</button>
            </div>
        </form>
    </div>
@endsection
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            // ========================== Create Quiz MCQ's DropDown Arrow ========================== //
