        ...
        <ul>
            ...
            <li class="sidebar-select">
                <div class="select-wrapper">
                    ...
                    <select class="SelectDropdown">
                        {{-- Select Calendar --}}
                        <option value="{{ route('calendar') }}" selected disabled
...
@section('content')
    {{-- Back to quiz list --}}
    <div style="margin-top:120px; margin-left:260px;">
        <a href="{{ url()->previous() }}" class="btn btn-secondary mt-3">
           <i class="fa fa-arrow-circle-left me-2" aria-hidden="true"></i>Back
        </a>
    </div>
    <div class="container mt-5 p-5">
        <h1 class="text-center"><i class="fa fa-pen-square me-2" aria-hidden="true"></i>Update Quiz</h1>
        <form action="{{ route('update_quiz_post',$update_quiz->id) }}" id="update_quiz" method="post">
            @csrf
            {{-- Question field --}}
            <div class="mt-3">
                <label>Question:</label>
                <div class="input-wrapper">
                    <input type="text" name="question" value="{{ $update_quiz->question }}" class="form-control">
            ...
            <div class="mt-3">
                ...
                <div class="input-wrapper">
                    <input type="text" name="option1" value="{{ $update_quiz->option1 }}" class="form-control">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Option 2 field --}}
            <div class="mt-3">
                ...
                <div class="input-wrapper">
                    <input type="text" name="option2" value="{{ $update_quiz->option2 }}" class="form-control">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Option 3 field --}}
            <div class="mt-3">
                ...
                <div class="input-wrapper">
                    <input type="text" name="option3" value="{{ $update_quiz->option3 }}" class="form-control">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Option 4 field --}}
            <div class="mt-3">
                ...
                <div class="input-wrapper">
                    <input type="text" name="option4" value="{{ $update_quiz->option4 }}" class="form-control">
                    <div class="error-icon">!</div>
                </div>
            </div>
            ...
            <div class="mt-3">
                ...
                <div class="input-wrapper">
                    <input type="number" name="correct_option" value="{{ $update_quiz->correct_option }}" class="form-control"
                        min="1" max="4">
                    <div class="error-icon">!</div>
                </div>
            </div>
            ...
            <div class="mt-3 text-center">
                <button type="submit" class="btn btn-primary"><i class="fa fa-pen-square me-2" aria-hidden="true"></i>Update Continue</button>
            </div>
        </form>
    </div>
@endsection
...
@section('scripts')
    <script>
        $(document).ready(function() {
            $('#update_quiz').on('submit',function(e) {
                e.preventDefault();
                update_quiz = $(this).attr('action');
