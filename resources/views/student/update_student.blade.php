...
@section('content')
    ...
    <div class="main-center">
        <h1><i class="fa fa-pencil-square me-2" aria-hidden="true"></i>Update Student</h1>
        <form action="{{ route('update_studentPost',$update_student->id) }}" id="student_updateAjax" method="post" enctype="multipart/form-data">
            @csrf
            {{-- Name field --}}
            <div class="form-group">
                <label class="form-label">First Name <label>
                <div class="input-wrapper">
                    <input type="text" name="name" value="{{ $update_student->name }}" placeholder="Enter name">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="last_name" value="{{ $update_student->last_name }}" placeholder="Enter last name">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Phone field --}}
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="number" name="phone" value="{{ $update_student->phone }}" placeholder="Enter phone">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Email field --}}
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="email" name="email" value="{{ $update_student->email }}" placeholder="Enter email">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Image picture --}}
            <div class="form-group">
                <img id="imagePreview" src="{{ $update_student->image ? asset('/Student_Image/'.$update_student->image): 
                    asset('/Student_Image/default.png') }}" alt="Student Image">
            </div>
            {{-- Image field --}}
            <div class="form-group">
...
@section('scripts')
    <script>
        $(document).ready(function() {
            $('#student_updateAjax').on('submit',function(e) {
                e.preventDefault();
                var formData = new FormData(this);
                var update_Student = $(this).attr('action');
