    ...
    <div class="container mt-5 p-5">
        <div class="card p-5 shadow-lg">
            <div class="text-center mt-2">
                <h2 class="fw-bold"><i class="fa fa-eye me-2" aria-hidden="true"></i>View Student</h2>
                <img src="{{ asset('Student_Image/'.$view_student->image) }}" 
                    class="rounded-circle mt-2 img-fluid"
                    style="width:280px; height: 280px; object-fit: cover;" alt="Student Image">
                <h2 class="fw-bold">{{ $view_student->name }}</h2>
                <p><strong>Last Name:</strong> {{ $view_student->last_name }}</p>
                <p><strong>Phone:</strong> {{ $view_student->phone }}</p>
                <p><strong>Email:</strong> {{ $view_student->email }}</p>
                {{-- Back to student list --}}
                <a href="{{ url()->previous() }}" class="btn btn-primary">
                    <i class="fa fa-circle-arrow-left me-2"></i>Back
                </a>
            </div>
        </div>
    </div>
