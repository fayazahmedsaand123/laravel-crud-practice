...
{{-- Title --}}
@section('title','History Calculator')
            ...
            <div class="col-md-6">
                <div class="card shadow-lg">
                    <div class="card-header bg-primary text-white text-center">
                        <h4 class="mb-0">History Calculator</h4>
                    </div>
                        ...
                        <ul class="list-group list-group-flush">
                            @foreach($history as $h)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-success rounded-pill">{{ $h->result }}</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
...
@section('scripts')
    <script>
        ...
        // ======================= History Calculator Dropdown Arrow =========================== //
