    ...
    <div class="container mt-5 p-5">
        <div class="card p-3 shadow-lg">
            <div class="text-center">
                <h2 class="fw-bold"><i class="fa fa-eye me-2" aria-hidden="true"></i>View Country</h2>
                <img src="{{ asset('Country_Image/'.$view_country->image) }}"
                   class="rounded-circle mt-2 me-2 img-fluid"
                   style="width: 280px; height: 280px; object-fit: cover;" alt="View Image">
            </div>
            <div class="text-center">
                <h2 class="fw-bold">{{ $view_country->country_name }}</h2>
            </div>
            <div class="text-center mt-2">
                <p><strong>Capital Name:</strong> {{ $view_country->capital_name }}</p>
                <p><strong>Gender:</strong> {{ $view_country->gender_name }}</p>
                <p><strong>Color:</strong> {{ $view_country->color_name }}</p>
                <p><strong>Student_ID:</strong>{{ $view_country->student_id }}</p>
                <p><strong>Teacher_ID:</strong>{{ $view_country->teacher_id }}</p>
                <p><strong>Subject_ID:</strong> {{ $view_country->subject_id }}</p>
            </div>
            <div class="text-center">
                {{-- Back to country list --}}
                <a href="{{ url()->previous() }}" class="btn btn-primary">
                   <i class="fa fa-arrow-circle-left me-2" aria-hidden="true"></i>Back</a>
            </div>
        </div>
    </div>
@endsection
