...
@section('content')
    ...
    <div class="main-center">
        <h1>➕ Country Form</h1>
        <form action="{{ route('country_input') }}" id="country_add" method="post" enctype="multipart/form-data">
            @csrf
            {{-- Country name field --}}
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="capital_name" placeholder="Enter captial">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Gender field --}}
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="gender_name" placeholder="Enter gender">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Color field --}}
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="color_name" placeholder="Enter color">
                    <div class="error-icon">!</div>
                </div>
            </div>
            {{-- Dropdown Student --}}
