...
@section('navbar')
    ...
    <div class="navbar">
        ...
        <div class="navbar-right">
            {{-- Search --}}
            <div class="search">
                <form action="{{ route('record_country') }}" method="get">
...
@section('content')
    <div class="main-center">
        ...
        <table>
            ...
            <tbody>
                @forelse ($record_country as $country)
                    <tr>
                        {{-- <td>{{ $country->id }}</td> --}}
                        <td>{{ $country->country_name }}</td>
                        <td>{{ $country->capital_name }}</td>
                        <td>{{ $country->gender_name }}</td>
                        <td>{{ $country->color_name }}</td>
                        <td>{{ $country->student_id }}</td>
                        <td>{{ $country->teacher_id }}</td>
                        <td>{{ $country->subject_id }}</td>
                        <td>
                            <img src="{{ asset('Country_Image/'.$country->image) }}" alt="Country Image">
                        </td>
                        <td>
                            <a href="{{ route('view_country',$country->id) }}" class="btn-view">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('update_country',$country->id) }}" class="btn-update">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('delete_country',$country->id) }}" 
                                class="btn-delete" data-id="{{ $country->id }}">
        ...
        {{-- Pagination --}}
        <div class="mt-3 pagination-left">{{ $record_country->links('pagination::bootstrap-5') }}</div>
    </div>
@endsection
