...
@section('content')
    <div class="containers">
        <div class="row">
            <div class="span10">
                <table class="table-condensed table-bordered table-striped" id="table">
                    <thead>
                        <tr>
                        <th colspan="7">
                            <span class="btn-group">
                                <button id="prevMonth" class="btn btn-dark"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></button>
                                <a id="monthYearBtn" class="btn active"></a>
                                <button id="nextMonth" class="btn btn-dark"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
                            </span>
                        </th>
                        </tr>
                        <tr>
...
@section('scripts')
    <script>
        ...
        function renderCalendar(month, year) {
            ...
            $('#monthYearBtn').text(`${monthNames[month]} ${year}`);
            ...
            for(var i=0; i<6; i++) { // max 6 rows
                ...
                for(var j=0; j<7; j++) {
                    if(i===0 && j<firstDay) {
                        ...
                        if(date === {{date('d')}} && month === {{date('m') - 1}} && year === {{date('Y')}}) { 
                            row.append(`<td id="td"><span class="today">${date}</span></td>`);
                        } 
                        else {
                            row.append(`<td id="td">${date}</td>`);
                        }
                        date++;
                    }
                }
